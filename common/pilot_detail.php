...
$html .= "<tr class='kb-table-row-even'><td class='kb-table-cell'><b>Real kills:</b></td><td class='kl-kill'>".$klist->getRealCount()."</td></tr>";
...
{
	if($klist->getRealCount() + $llist->getCount()) $pilot_survival = round($llist->getCount() / ($klist->getRealCount() + $llist->getCount()) * 100,2);
