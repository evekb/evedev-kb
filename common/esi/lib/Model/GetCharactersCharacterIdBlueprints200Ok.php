...
class GetCharactersCharacterIdBlueprints200Ok implements ArrayAccess
{
    ...
    /**
     * Sets item_id
     * @param int $item_id Unique ID for this item. The ID of an item is stable if that item is not repackaged, stacked, detached from a stack, assembled, or otherwise altered. If an item is changed in one of these ways, then the ID will also change (see notes below).
     * @return $this
     */
    ...
    /**
     * Sets location_id
     * @param int $location_id References a solar system, station or itemID if this blueprint is located within a container. If an itemID the Character - AssetList API must be queried to find the container using the itemID, from which the correct location of the Blueprint can be derived.
     * @return $this
     */
