 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetCorporationsCorporationIdWallets200Ok implements ArrayAccess
{
    /**
    ...
    public function setDivision($division)
    {
        ...
        if ($division > 7.0) {
            throw new \InvalidArgumentException('invalid value for $division when calling GetCorporationsCorporationIdWallets200Ok., must be smaller than or equal to 7.0.');
        }
        if ($division < 1.0) {
            throw new \InvalidArgumentException('invalid value for $division when calling GetCorporationsCorporationIdWallets200Ok., must be bigger than or equal to 1.0.');
        }
