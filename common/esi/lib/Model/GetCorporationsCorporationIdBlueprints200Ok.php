...
class GetCorporationsCorporationIdBlueprints200Ok implements ArrayAccess
{
    ...
    public function setMaterialEfficiency($material_efficiency)
    {
        ...
        if ($material_efficiency > 25.0) {
            throw new \InvalidArgumentException('invalid value for $material_efficiency when calling GetCorporationsCorporationIdBlueprints200Ok., must be smaller than or equal to 25.0.');
        }
