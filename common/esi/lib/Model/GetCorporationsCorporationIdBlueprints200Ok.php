 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetCorporationsCorporationIdBlueprints200Ok implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['material_efficiency'] > 10.0)) {
            $invalid_properties[] = "invalid value for 'material_efficiency', must be smaller than or equal to 10.0.";
        }
    ...
    public function setMaterialEfficiency($material_efficiency)
    {
        ...
        if ($material_efficiency > 10.0) {
            throw new \InvalidArgumentException('invalid value for $material_efficiency when calling GetCorporationsCorporationIdBlueprints200Ok., must be smaller than or equal to 10.0.');
        }
        if ($material_efficiency < 0.0) {
            throw new \InvalidArgumentException('invalid value for $material_efficiency when calling GetCorporationsCorporationIdBlueprints200Ok., must be bigger than or equal to 0.0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if ($quantity < -2.0) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling GetCorporationsCorporationIdBlueprints200Ok., must be bigger than or equal to -2.0.');
        }
    ...
    public function setRuns($runs)
    {
        ...
        if ($runs < -1.0) {
            throw new \InvalidArgumentException('invalid value for $runs when calling GetCorporationsCorporationIdBlueprints200Ok., must be bigger than or equal to -1.0.');
        }
    ...
    public function setTimeEfficiency($time_efficiency)
    {
        ...
        if ($time_efficiency > 20.0) {
            throw new \InvalidArgumentException('invalid value for $time_efficiency when calling GetCorporationsCorporationIdBlueprints200Ok., must be smaller than or equal to 20.0.');
        }
        if ($time_efficiency < 0.0) {
            throw new \InvalidArgumentException('invalid value for $time_efficiency when calling GetCorporationsCorporationIdBlueprints200Ok., must be bigger than or equal to 0.0.');
        }
