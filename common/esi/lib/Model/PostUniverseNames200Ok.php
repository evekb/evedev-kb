...
class PostUniverseNames200Ok implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("alliance", "character", "constellation", "corporation", "inventory_type", "region", "solar_system", "station", "faction");
    ...
    public function setCategory($category)
    {
        ...
        if (!in_array($category, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'category', must be one of 'alliance', 'character', 'constellation', 'corporation', 'inventory_type', 'region', 'solar_system', 'station', 'faction'");
        }
