...
/**
 * GetCorporationsCorporationIdOrdersHistory200Ok Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetCorporationsCorporationIdOrdersHistory200Ok implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'get_corporations_corporation_id_orders_history_200_ok';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['wallet_division'] = isset($data['wallet_division']) ? $data['wallet_division'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['wallet_division'] === null) {
            $invalid_properties[] = "'wallet_division' can't be null";
        }
        if (($this->container['wallet_division'] > 7.0)) {
            $invalid_properties[] = "invalid value for 'wallet_division', must be smaller than or equal to 7.0.";
        }

        if (($this->container['wallet_division'] < 1.0)) {
            $invalid_properties[] = "invalid value for 'wallet_division', must be bigger than or equal to 1.0.";
        }
    ...
    public function setWalletDivision($wallet_division)
    {
        ...
        if ($wallet_division > 7.0) {
            throw new \InvalidArgumentException('invalid value for $wallet_division when calling GetCorporationsCorporationIdOrdersHistory200Ok., must be smaller than or equal to 7.0.');
        }
        if ($wallet_division < 1.0) {
            throw new \InvalidArgumentException('invalid value for $wallet_division when calling GetCorporationsCorporationIdOrdersHistory200Ok., must be bigger than or equal to 1.0.');
        }
