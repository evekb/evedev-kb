...
class GetCharactersCharacterIdStandings200Ok implements ArrayAccess
{
    ...
    public function setStanding($standing)
    {
        ...
        if ($standing > 10.0) {
            throw new \InvalidArgumentException('invalid value for $standing when calling GetCharactersCharacterIdStandings200Ok., must be smaller than or equal to 10.0.');
        }
        if ($standing < -10.0) {
            throw new \InvalidArgumentException('invalid value for $standing when calling GetCharactersCharacterIdStandings200Ok., must be bigger than or equal to -10.0.');
        }
