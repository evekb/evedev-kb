...
class GetCorporationsCorporationIdWalletsDivisionJournal200Ok implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'tax_receiver_id' => 'int',
        'tax' => 'double',
        'extra_info' => '\Swagger\Client\Model\V2corporationscorporationIdwalletsdivisionjournalExtraInfo'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("character", "corporation", "alliance", "faction", "system");
    ...
    /**
     * Sets ref_type
     * @param string $ref_type Transaction type, different type of transaction will populate different fields in `extra_info` Note: If you have an existing XML API application that is using ref_types, you will need to know which string ESI ref_type maps to which integer. You can use the following gist to see string->int mappings: https://gist.github.com/ccp-zoetrope/c03db66d90c2148724c06171bc52e0ec
     * @return $this
     */
    ...
    public function setFirstPartyType($first_party_type)
    {
        ...
        if (!in_array($first_party_type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'first_party_type', must be one of 'character', 'corporation', 'alliance', 'faction', 'system'");
        }
    ...
    public function setSecondPartyType($second_party_type)
    {
        ...
        if (!in_array($second_party_type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'second_party_type', must be one of 'character', 'corporation', 'alliance', 'faction', 'system'");
        }
    ...
    /**
     * Gets extra_info
     * @return \Swagger\Client\Model\V2corporationscorporationIdwalletsdivisionjournalExtraInfo
     */
    ...
    /**
     * Sets extra_info
     * @param \Swagger\Client\Model\V2corporationscorporationIdwalletsdivisionjournalExtraInfo $extra_info
     * @return $this
     */
