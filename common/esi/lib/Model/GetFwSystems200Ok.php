...
class GetFwSystems200Ok implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("captured", "contested", "uncontested", "vulnerable");
        if (!in_array($this->container['contested'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'contested', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('captured', 'contested', 'uncontested', 'vulnerable');
        if (!in_array($contested, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'contested', must be one of 'captured', 'contested', 'uncontested', 'vulnerable'");
        }
