...
/**
 * GetCorporationsCorporationIdMembersTitles200Ok Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetCorporationsCorporationIdMembersTitles200Ok implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'get_corporations_corporation_id_members_titles_200_ok';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['titles'] === null) {
            $invalid_properties[] = "'titles' can't be null";
        }
