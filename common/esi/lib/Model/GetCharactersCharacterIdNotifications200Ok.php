...
class GetCharactersCharacterIdNotifications200Ok implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("character", "corporation", "alliance", "faction", "other");
    ...
    public function setSenderType($sender_type)
    {
        ...
        if (!in_array($sender_type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'sender_type', must be one of 'character', 'corporation', 'alliance', 'faction', 'other'");
        }
