 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetCorporationsCorporationIdOrders200Ok implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("cancelled", "character_deleted", "closed", "expired", "open", "pending");
    ...
    public function setState($state)
    {
        ...
        if (!in_array($state, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'state', must be one of 'cancelled', 'character_deleted', 'closed', 'expired', 'open', 'pending'");
        }
    ...
    public function setWalletDivision($wallet_division)
    {
        ...
        if ($wallet_division > 7.0) {
            throw new \InvalidArgumentException('invalid value for $wallet_division when calling GetCorporationsCorporationIdOrders200Ok., must be smaller than or equal to 7.0.');
        }
        if ($wallet_division < 1.0) {
            throw new \InvalidArgumentException('invalid value for $wallet_division when calling GetCorporationsCorporationIdOrders200Ok., must be bigger than or equal to 1.0.');
        }
