...
class PostCharactersCharacterIdFittingsFitting implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'description' => 'string',
        'items' => '\Swagger\Client\Model\V2characterscharacterIdfittingsItems1[]',
        'name' => 'string',
        'ship_type_id' => 'int'
    );
    ...
    /**
     * Gets items
     * @return \Swagger\Client\Model\V2characterscharacterIdfittingsItems1[]
     */
    ...
    /**
     * Sets items
     * @param \Swagger\Client\Model\V2characterscharacterIdfittingsItems1[] $items items array
     * @return $this
     */
