 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetCorporationsCorporationIdIndustryJobs200Ok implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("active", "cancelled", "delivered", "paused", "ready", "reverted");
    ...
    public function setStatus($status)
    {
        ...
        if (!in_array($status, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'status', must be one of 'active', 'cancelled', 'delivered', 'paused', 'ready', 'reverted'");
        }
