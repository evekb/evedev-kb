...
class GetCorporationsCorporationIdStructures200Ok implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'services' => '\Swagger\Client\Model\V3corporationscorporationIdstructuresServices[]',
        'state' => 'string',
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['reinforce_weekday']) && ($this->container['reinforce_weekday'] > 6.0)) {
            $invalid_properties[] = "invalid value for 'reinforce_weekday', must be smaller than or equal to 6.0.";
        }

        if (!is_null($this->container['reinforce_weekday']) && ($this->container['reinforce_weekday'] < 0.0)) {
        ...
        $allowed_values = array("anchor_vulnerable", "anchoring", "armor_reinforce", "armor_vulnerable", "deploy_vulnerable", "fitting_invulnerable", "hull_reinforce", "hull_vulnerable", "online_deprecated", "onlining_vulnerable", "shield_vulnerable", "unanchored", "unknown");
    ...
    /**
     * Gets services
     * @return \Swagger\Client\Model\V3corporationscorporationIdstructuresServices[]
     */
    ...
    /**
     * Sets services
     * @param \Swagger\Client\Model\V3corporationscorporationIdstructuresServices[] $services Contains a list of service upgrades, and their state
     * @return $this
     */
    ...
    public function setState($state)
    {
        ...
        if (!in_array($state, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'state', must be one of 'anchor_vulnerable', 'anchoring', 'armor_reinforce', 'armor_vulnerable', 'deploy_vulnerable', 'fitting_invulnerable', 'hull_reinforce', 'hull_vulnerable', 'online_deprecated', 'onlining_vulnerable', 'shield_vulnerable', 'unanchored', 'unknown'");
        }
