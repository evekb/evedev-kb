...
class SearchApi
{
     ...
     */
    public function getCharactersCharacterIdSearch($categories, $character_id, $search, $datasource = null, $if_none_match = null, $language = null, $strict = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getCharactersCharacterIdSearchWithHttpInfo($categories, $character_id, $search, $datasource, $if_none_match, $language, $strict, $token, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getCharactersCharacterIdSearchWithHttpInfo($categories, $character_id, $search, $datasource = null, $if_none_match = null, $language = null, $strict = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getSearch($categories, $search, $datasource = null, $if_none_match = null, $language = null, $strict = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getSearchWithHttpInfo($categories, $search, $datasource, $if_none_match, $language, $strict, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getSearchWithHttpInfo($categories, $search, $datasource = null, $if_none_match = null, $language = null, $strict = null, $user_agent = null, $x_user_agent = null)
    {
        // verify the required parameter 'categories' is set
        if ($categories === null) {
