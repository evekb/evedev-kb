...
class KillmailsApi
{
    ...
    public function getCharactersCharacterIdKillmailsRecentWithHttpInfo($character_id, $datasource = null, $if_none_match = null, $page = null, $token = null)
    {
        ...
        if (!is_null($page) && ($page < 1.0)) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling KillmailsApi.getCharactersCharacterIdKillmailsRecent, must be bigger than or equal to 1.0.');
        }
    ...
    public function getCorporationsCorporationIdKillmailsRecentWithHttpInfo($corporation_id, $datasource = null, $if_none_match = null, $page = null, $token = null)
    {
        ...
        if (!is_null($page) && ($page < 1.0)) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling KillmailsApi.getCorporationsCorporationIdKillmailsRecent, must be bigger than or equal to 1.0.');
        }
