...
class IndustryApi
{
     ...
     */
    public function getIndustryFacilities($datasource = null)
    {
        list($response) = $this->getIndustryFacilitiesWithHttpInfo($datasource);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getIndustryFacilitiesWithHttpInfo($datasource = null)
    {
        // parse inputs
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getIndustrySystems($datasource = null)
    {
        list($response) = $this->getIndustrySystemsWithHttpInfo($datasource);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getIndustrySystemsWithHttpInfo($datasource = null)
    {
        // parse inputs
