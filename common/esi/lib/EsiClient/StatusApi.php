...
class StatusApi
{
     ...
     */
    public function getStatus($datasource = null, $if_none_match = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getStatusWithHttpInfo($datasource, $if_none_match, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getStatusWithHttpInfo($datasource = null, $if_none_match = null, $user_agent = null, $x_user_agent = null)
    {
        // parse inputs
