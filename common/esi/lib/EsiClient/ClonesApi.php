...
class ClonesApi
{
     ...
     */
    public function getCharactersCharacterIdClones($character_id, $datasource = null, $if_none_match = null, $token = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getCharactersCharacterIdClonesWithHttpInfo($character_id, $datasource = null, $if_none_match = null, $token = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getCharactersCharacterIdImplants($character_id, $datasource = null, $if_none_match = null, $token = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getCharactersCharacterIdImplantsWithHttpInfo($character_id, $datasource = null, $if_none_match = null, $token = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null) {
