...
class ClonesApi
{
     ...
     */
    public function getCharactersCharacterIdClones($character_id, $datasource = null, $if_none_match = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getCharactersCharacterIdClonesWithHttpInfo($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getCharactersCharacterIdClonesWithHttpInfo($character_id, $datasource = null, $if_none_match = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        if (($character_id < 1.0)) {
            throw new \InvalidArgumentException('invalid value for "$character_id" when calling ClonesApi.getCharactersCharacterIdClones, must be bigger than or equal to 1.0.');
        }

        // parse inputs
        $resourcePath = "/v3/characters/{character_id}/clones/";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getCharactersCharacterIdImplants($character_id, $datasource = null, $if_none_match = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getCharactersCharacterIdImplantsWithHttpInfo($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getCharactersCharacterIdImplantsWithHttpInfo($character_id, $datasource = null, $if_none_match = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null) {
        ...
        if (($character_id < 1.0)) {
            throw new \InvalidArgumentException('invalid value for "$character_id" when calling ClonesApi.getCharactersCharacterIdImplants, must be bigger than or equal to 1.0.');
        }
