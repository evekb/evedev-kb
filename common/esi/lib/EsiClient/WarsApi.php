...
class WarsApi
{
     ...
     */
    public function getWars($datasource = null, $if_none_match = null, $max_war_id = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getWarsWithHttpInfo($datasource, $if_none_match, $max_war_id, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getWarsWithHttpInfo($datasource = null, $if_none_match = null, $max_war_id = null, $user_agent = null, $x_user_agent = null)
    {
        // parse inputs
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getWarsWarId($war_id, $datasource = null, $if_none_match = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getWarsWarIdWithHttpInfo($war_id, $datasource, $if_none_match, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getWarsWarIdWithHttpInfo($war_id, $datasource = null, $if_none_match = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        if (($war_id < 1.0)) {
            throw new \InvalidArgumentException('invalid value for "$war_id" when calling WarsApi.getWarsWarId, must be bigger than or equal to 1.0.');
        }
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetWarsWarIdOk', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getWarsWarIdKillmails($war_id, $datasource = null, $if_none_match = null, $page = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getWarsWarIdKillmailsWithHttpInfo($war_id, $datasource, $if_none_match, $page, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getWarsWarIdKillmailsWithHttpInfo($war_id, $datasource = null, $if_none_match = null, $page = null, $user_agent = null, $x_user_agent = null)
    {
        // verify the required parameter 'war_id' is set
        if ($war_id === null) {
        ...
        if (($war_id < 1.0)) {
            throw new \InvalidArgumentException('invalid value for "$war_id" when calling WarsApi.getWarsWarIdKillmails, must be bigger than or equal to 1.0.');
        }
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetWarsWarIdKillmails200Ok[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
