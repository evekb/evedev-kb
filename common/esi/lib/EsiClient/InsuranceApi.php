...
class InsuranceApi
{
     ...
     */
    public function getInsurancePrices($language = null, $datasource = null)
    {
        list($response) = $this->getInsurancePricesWithHttpInfo($language, $datasource);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getInsurancePricesWithHttpInfo($language = null, $datasource = null)
    {
        // parse inputs
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    ...
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetInsurancePricesInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
