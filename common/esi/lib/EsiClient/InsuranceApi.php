...
class InsuranceApi
{
     ...
     */
    public function getInsurancePrices($datasource = null, $if_none_match = null, $language = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getInsurancePricesWithHttpInfo($datasource, $if_none_match, $language, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getInsurancePricesWithHttpInfo($datasource = null, $if_none_match = null, $language = null, $user_agent = null, $x_user_agent = null)
    {
        // parse inputs
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetInsurancePrices200Ok[]', $httpHeader), $statusCode, $httpHeader);
