...
class LoyaltyApi
{
     ...
     */
    public function getCharactersCharacterIdLoyaltyPoints($character_id, $datasource = null, $if_none_match = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getCharactersCharacterIdLoyaltyPointsWithHttpInfo($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getCharactersCharacterIdLoyaltyPointsWithHttpInfo($character_id, $datasource = null, $if_none_match = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getLoyaltyStoresCorporationIdOffers($corporation_id, $datasource = null, $if_none_match = null, $user_agent = null, $x_user_agent = null)
    {
        list($response) = $this->getLoyaltyStoresCorporationIdOffersWithHttpInfo($corporation_id, $datasource, $if_none_match, $user_agent, $x_user_agent);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getLoyaltyStoresCorporationIdOffersWithHttpInfo($corporation_id, $datasource = null, $if_none_match = null, $user_agent = null, $x_user_agent = null)
    {
