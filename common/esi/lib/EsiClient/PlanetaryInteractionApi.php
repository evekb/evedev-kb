        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    ...
                    break;
                case 403:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdPlanetsForbidden', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdPlanetsInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    ...
                    break;
                case 403:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdPlanetsPlanetIdForbidden', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    ...
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetCharactersCharacterIdPlanetsPlanetIdInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    ...
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\GetUniverseSchematicsSchematicIdInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
