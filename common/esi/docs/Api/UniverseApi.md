...
> int[] getUniverseConstellations($datasource)
...
try {
    $result = $api_instance->getUniverseConstellations($datasource);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\GetUniverseConstellationsConstellationIdOk getUniverseConstellationsConstellationId($constellation_id, $language, $datasource)
...
try {
    $result = $api_instance->getUniverseConstellationsConstellationId($constellation_id, $language, $datasource);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\GetUniverseMoonsMoonIdOk getUniverseMoonsMoonId($moon_id, $datasource)
...
try {
    $result = $api_instance->getUniverseMoonsMoonId($moon_id, $datasource);
    print_r($result);
} catch (Exception $e) {
...
# **getUniverseRegions**
> int[] getUniverseRegions($datasource)
...
try {
    $result = $api_instance->getUniverseRegions($datasource);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\GetUniverseRegionsRegionIdOk getUniverseRegionsRegionId($region_id, $language, $datasource)
...
try {
    $result = $api_instance->getUniverseRegionsRegionId($region_id, $language, $datasource);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\GetUniverseStargatesStargateIdOk getUniverseStargatesStargateId($stargate_id, $datasource)
...
try {
    $result = $api_instance->getUniverseStargatesStargateId($stargate_id, $datasource);
    print_r($result);
} catch (Exception $e) {
...
Public information on stations  ---  Alternate route: `/v1/universe/stations/{station_id}/`  Alternate route: `/legacy/universe/stations/{station_id}/`   ---  This route is cached for up to 3600 seconds
...
# **getUniverseSystems**
> int[] getUniverseSystems($datasource)
...
try {
    $result = $api_instance->getUniverseSystems($datasource);
    print_r($result);
} catch (Exception $e) {
...
Information on solar systems  ---  Alternate route: `/v1/universe/systems/{system_id}/`  Alternate route: `/legacy/universe/systems/{system_id}/`   ---  This route is cached for up to 3600 seconds
