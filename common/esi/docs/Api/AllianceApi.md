...
try {
    $result = $api_instance->getAlliances($datasource, $if_none_match, $user_agent, $x_user_agent);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $api_instance->getAlliancesAllianceId($alliance_id, $datasource, $if_none_match, $user_agent, $x_user_agent);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $api_instance->getAlliancesAllianceIdCorporations($alliance_id, $datasource, $if_none_match, $user_agent, $x_user_agent);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $api_instance->getAlliancesAllianceIdIcons($alliance_id, $datasource, $if_none_match, $user_agent, $x_user_agent);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $api_instance->getAlliancesNames($alliance_ids, $datasource, $if_none_match, $user_agent, $x_user_agent);
    print_r($result);
} catch (Exception $e) {
