...
> \Swagger\Client\Model\GetCharactersCharacterIdClonesOk getCharactersCharacterIdClones($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent)
...
try {
    $result = $api_instance->getCharactersCharacterIdClones($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent);
    print_r($result);
} catch (Exception $e) {
...
> int[] getCharactersCharacterIdImplants($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent)
...
try {
    $result = $api_instance->getCharactersCharacterIdImplants($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent);
    print_r($result);
} catch (Exception $e) {
