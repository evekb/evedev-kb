...
class Translate
{
	...
	function getTranslation($killmail)
	{
		...
		else if ($this->language_ == 'russian')
		{
		...
		else if($this->language_ == 'dominion')
		{
		...
		else if($this->language_ == 'cru11')
		{
			//Missiles, Torps, Rockets - trailing spaces are important on some of the entries
			$search = array('/Bane/', '/Bloodclaw/', '/Cataclysm/', '/Sabretooth/',
				'/Devastator Cruise/', '/Devastator Fury/', '/Devastator Precision/',
				'/Foxfire/', '/Wrath /', '/Gremlin/', '/Widowmaker/', '/Thunderbolt/',
				'/Flameburst/', '/Phalanx /', '/Hellfire/', '/Juggernaut /', '/Havoc/',
				'/Torrent/', '/Fulmination/', '/Scourge/', '/Thorn/', '/Catastrophe/',
				'/Paradise Cruise/', '/Paradise Precision/', '/Doom /', '/Sol /',
				'/Thor Citadel/', '/Terror Assault/', '/Paradise Fury/', '/Terror Javelin/',
				'/Piranha Light/', '/Piranha Fury/', '/Piranha Precision/', '/Thunar Citadel/',
				'/Purgatory Citadel/', '/Rajas Citadel/', '/Terror Rage/', '/Rift Citadel/');
			$replace = array('Nova', 'Trauma', 'Inferno', 'Mjolnir', 
				'Nova Cruise', 'Nova Fury', 'Nova Precision',
				'Inferno', 'Trauma ', 'Mjolnir', 'Inferno', 'Mjolnir',
				'Inferno', 'Nova ', 'Inferno', 'Trauma ', 'Nova',
				'Mjolnir', 'Nova', 'Trauma', 'Trauma', 'Nova',
				'Mjolnir Cruise', 'Mjolnir Precision', 'Nova ', 'Inferno ',
				'Mjolnir Citadel', 'Trauma Assault', 'Mjolnir Fury', 'Trauma Javelin',
				'Nova Light', 'Nova Fury', 'Nova Precision', 'Mjolnir Citadel',
				'Inferno Citadel', 'Trauma Citadel', 'Trauma Rage', 'Trauma Citadel');
			$this->killmail_ = preg_replace($search, $replace, $this->killmail_);
			
			//Afterburners & MWDs
			$search = array("Catalyzed Cold-Gas Arcjet Thrusters", "Cold-Gas Arcjet Thrusters", "LiF Fueled Booster Rockets",
				"Monopropellant Hydrazine Boosters", "Phased Monopropellant I Hydrazine Boosters",
				"Quad LiF Fueled Booster Rockets", "Y-S8 Hydrocarbon Afterburners",
				"Y-T8 Overcharged Hydrocarbon Microwarpdrive");
			$replace = array("Limited 1MN MicroWarpdrive I", "Experimental 1MN Afterburner I",
				"Experimental 100MN Afterburner I", "Limited 1MN Afterburner I", "Upgraded 1MN Microwarpdrive I",
