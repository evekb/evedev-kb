...
<form id="options" name="options" method="post" action="?step=3">
    ...
    <tr><td width="120"><b>Engine:</b></td><td><input type=radio name=engine id=engine value="InnoDB"
    {if $db_engine != "MyISAM"} CHECKED
    {/if}
    >InnoDB <input
    {if $db_engine == "MyISAM"} CHECKED
    {/if}
    type=radio name=engine id=engine value="MyISAM">MyISAM</tr>
