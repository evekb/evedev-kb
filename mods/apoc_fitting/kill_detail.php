...
$page=new Page('Kill details');
$page->addHeader('<link rel="stylesheet" type="text/css" href="mods/apoc_fitting/style.css">');
...
// Rostik 11/03/2009
    ...
    $handle=@fopen("mods/apoc_fitting/ItemsList", "r");
...
class FBlowBox
{
    ...
    {
        global $smarty;
        return $smarty->fetch('../mods/apoc_fitting/damage_box.tpl');
    }
}
...
$html.=$smarty->fetch('../mods/apoc_fitting/kill_detail.tpl');

$html.='<br/><hr><!-- <div style="font-size: 10px;"><b>Based on Apoc Fitting v2.0</a> (2009 - Ben Thomas</a>)</div> -->';
