        ...
        <td width=360 align=left valign=top><table class=kb-table width=360 cellpadding=0 cellspacing=1 border=0>
            ...
            <table class=kb_table_involved width=360 border=0 cellspacing="1">
                <tr class=kb-table-header>
                    <th>Alliances</th> <th>Corporations</th> <th>Ships</th>
                </tr>  
...
<!--                <tr class=kb-table-header>
                ...
                <tr class=kb-table-row-even>
                    ...
                    <td class=kb-table-cell>
                        {foreach from=$InvCorps key=key item=l}
                            ({$l}) {$key} <br/>
                        {/foreach}  
                    </td>
                    <td class=kb-table-cell NOWRAP>
                        {foreach from=$InvShips key=key item=l}
                            ({$l}) {$key} <br/>
                        {/foreach}  
                    </td>
                ...
                {foreach from=$involved key=key item=i}
                    {if $IsAlly eq true} 
                        ...
                        <tr class={cycle name=ccl}>
                           ...
                           {else}
                                <td class=kb-table-cell style="padding-top: 1px; padding-bottom: 1px; background-color: {$AllyCorps[$i.CorpName]};"><a href="{$i.CorpURL}">{$i.CorpName}</a></td>
                           {/if} 
                        </tr>
                        <tr class={cycle name=ccl}>
                            {if $i.AlliName eq $HomeName}
                                <td class=kb-table-cell style="padding-top: 1px; padding-bottom: 1px; background-color: #505000;"><a href="{$i.AllyURL}">{$i.AlliName}</a></td>
                            {else}
...
{if $config->get('comments')}{$comments}{/if}
		...
		<div id="mask" style="position:absolute; left:0px; top:0px; width:398px; height:398px; z-index:0;">
			<img border="0" style="position:absolute;" height="398" width="398" filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(
     			src="{$img_url}/{$themedir}/{$panel_colour}.png", sizingMethod='image');"></div>
		
		<div id="highx" style="position:absolute; left:0px; top:0px; width:398px; height:398px; z-index:0;">
			<img src="{$img_url}/{$themedir}/{$hic}ph.gif" border="0"></div>
		...
		<div id="midx" style="position:absolute; left:0px; top:0px; width:398px; height:398px; z-index:0;">
			<img src="{$img_url}/{$themedir}/{$medc}pm.gif" border="0"></div>
		...
		<div id="lowx" style="position:absolute; left:0px; top:0px; width:398px; height:398px; z-index:0;">
			<img src="{$img_url}/{$themedir}/{$lowc}pl.gif" border="0"></div>
...
{if $item_values}
                ...
                <tr class={cycle name=ccl} style="background-color: #600000;">
                    ...
                    <td td style="border: 1px solid #C00000;" align="right">{$TotalLoss}</td>
                </tr>
{/if}
            </table>
        </td>
