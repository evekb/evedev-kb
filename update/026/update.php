...
function update026()
{
	...
	{
		if(is_null(config::get('026updatestatus'))) config::set('026updatestatus',0);
		$qry = new DBQuery(true);

		if(config::get('026updatestatus') <1)
		{
			// create table
		...
		config::del("026updatestatus");

		$smarty->assign('refresh',1);
		$smarty->assign('content', "Update 026 completed.");
