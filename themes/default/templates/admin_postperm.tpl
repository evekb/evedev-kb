...
<p><a href="{$kb_host}/?a=admin_postperm&amp;authall=0&amp;akey={$akey}">Enable authorisation checking.</a></p>
{else}
...
<br/>
<form id="search" action="{$kb_host}/?a=admin_postperm&amp;akey={$akey}" method="post">
...
<br/>
<a href="{$kb_host}/?a=admin_postperm&amp;authall=1&amp;akey={$akey}">Disable authorisation checking (and delete all granted permissions).</a>
{/if}