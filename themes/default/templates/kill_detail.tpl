...
{if $config->get('fp_show')}
		...
		<div id="midx_" style="position:absolute; left:0px; top:0px; width:398px; height:398px; z-index:0;">
		...
		<div id="mid4l_" style="position:absolute; left:128px; top:85px; width:24px; height:24px; z-index:2;">{$fitting_ammo_mid.3.type}</div>
		...
		<div id="lowx_" style="position:absolute; left:0px; top:0px; width:398px; height:398px; z-index:0;">
