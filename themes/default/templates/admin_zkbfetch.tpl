...
{/foreach}
	...
	<br />
        ...
        <table>
            ...
            <tr>
                <td style='height:30px; width:250px'>Max number of kills per cycle [10..200]</td>
                <td><input type='text' size="5" name='maxNumberOfKillsPerCycle' id='maxNumberOfKillsPerCycle' value="{if isset($maxNumberOfKillsPerCycle)}{$maxNumberOfKillsPerCycle}{/if}" /></td>
            </tr>
        </table>
	<br />
