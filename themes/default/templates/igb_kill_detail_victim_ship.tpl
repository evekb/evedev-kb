...
{cycle reset=true print=false name=ccl values="kb-table-row-even,kb-table-row-odd"}
	<table class="kb-table">
		...
		<tr class="{cycle name="ccl"}" >
			<td class="logo" rowspan="3" onClick="CCPEVE.showPreview({$victimShipID})"><img src="{$victimShipImage}" alt="{$victimShipName}"/> </td>
			<td>Ship:</td>
			<td><a href="javascript:CCPEVE.showInfo({$victimShipID})">{$victimShipName}</a> ({$victimShipClassName})</td>
		</tr>
		<tr class="{cycle name="ccl"}">
			<td>Location:</td>
